node {
    ...
    stage('Prisma Cloud Scan Lambda Function IaC') {
        ...
        try {
	        withCredentials([
            	string(
              		credentialsId: 'PrismaCodeSecCEUR',
              		variable: 'BC_API')
            ]) {
                // IF YOU WANT THE BUILD TO PASS, USE THE ITEM WITH --check MEDIUM
		        response = sh(script:"checkov --file MYPLAN.json --prisma-api-url https://api.eu.prismacloud.io --bc-api-key $BC_API --repo-id GBaileyMcEwan/lambdaapp -b main --soft-fail -o junitxml > result.xml || true", returnStdout:true).trim() // -o junitxml > result.xml || true"
        ...
        withCredentials([
            string(
                ...
                // IF YOU WANT THE BUILD TO PASS, USE THE ITEM WITH --check MEDIUM   
                sh('checkov --file MYPLAN.json --prisma-api-url https://api.eu.prismacloud.io --bc-api-key $BC_API --repo-id GBaileyMcEwan/lambdaapp -b main --compact --quiet --use-enforcement-rules')
    ...
    stage('Prisma Cloud scan DockerFile') {
        try {
	        ...
	        withCredentials([
		        ...
		        response = sh(script:"checkov --file nginx/Dockerfile --prisma-api-url https://api.eu.prismacloud.io --bc-api-key $BC_API --repo-id GBaileyMcEwan/lambdaapp -b main --soft-fail -o junitxml > result.xml || true", returnStdout:true).trim() // -o junitxml > result.xml || true"
            }
        ...
        withCredentials([
            string(
                ...
                sh('checkov --file nginx/Dockerfile --prisma-api-url https://api.eu.prismacloud.io --bc-api-key $BC_API --repo-id GBaileyMcEwan/lambdaapp -b main --compact --quiet --use-enforcement-rules') 
                // --soft-fail')
	        }
        }    
	    catch (err) {
    ...
    stage('Prisma Cloud scan Open Source Dependencies') {
        try {
             //response = sh(script:"checkov --file files/deploy.yml", returnStdout:true).trim() // -o junitxml > result.xml || true"
	        withCredentials([
            	string(
		        ...
		        response = sh(script:"checkov --file nginx/requirements.txt --prisma-api-url https://api.eu.prismacloud.io --bc-api-key $BC_API --repo-id GBaileyMcEwan/lambdaapp -b main --soft-fail -o junitxml > result.xml || true", returnStdout:true).trim() // -o junitxml > result.xml || true"
            }
        ...
        withCredentials([
            string(
                ...
                sh('checkov --file nginx/requirements.txt --prisma-api-url https://api.eu.prismacloud.io --bc-api-key $BC_API --repo-id GBaileyMcEwan/lambdaapp -b main --compact --quiet --use-enforcement-rules') 
                // --soft-fail')
	        }
        }    
	    catch (err) {
    ...
    stage('Prisma Cloud scan of k8s manifest IaC') {
        try {
	        ...
	        withCredentials([
		        ...
		        response = sh(script:"checkov --file k8s_iac/myNginx.yml --prisma-api-url https://api.eu.prismacloud.io --bc-api-key $BC_API --repo-id GBaileyMcEwan/lambdaapp -b main --check MEDIUM --compact --quiet -o junitxml > result.xml || true", returnStdout:true).trim() // -o junitxml > result.xml || true"
             }
            ...
            string(
                ...
                sh('checkov --file k8s_iac/myNginx.yml --prisma-api-url https://api.eu.prismacloud.io --bc-api-key $BC_API --repo-id GBaileyMcEwan/lambdaapp -b main --check MEDIUM --compact --quiet --use-enforcement-rules')
                // --soft-fail')
	        }
	    }
	    catch (err) {
